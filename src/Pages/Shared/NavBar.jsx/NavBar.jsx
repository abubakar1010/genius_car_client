        ...
        <Navbar className="sticky top-0 z-10  max-w-full shadow-none rounded-none py-2 lg:py-4 ">
          <div className="flex items-center justify-between text-blue-gray-900">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-x-8">
                {
                  user && <button className="hidden xl:inline-block bg-gradient-to-r from-[#6dc234] to-[#6dc234ad]  py-2 px-5 text-white font-bold rounded-md text-xl hover:scale-105 duration-500 hover:duration-500  ">
                  <span>Log Out</span>
                </button>
                }
                {userData || user ? (
          ...
          <MobileNav open={openNav}>
            ...
            <div className="flex items-center gap-x-7">
                  ...
                  <button className=" hover:bg-gradient-to-r from-[#6dc234] to-[#6dc234ad]  py-2 px-5 hover:text-white font-bold rounded-md text-xl hover:scale-105 duration-500 hover:duration-500 w-full text-[#2e2d2d] border border-[#FF8938]  ">
                  <span>Log Out</span>
                </button>
